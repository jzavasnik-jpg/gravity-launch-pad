...
export default function Pipeline() {
  ...
  const [selectedAssetIds, setSelectedAssetIds] = new Set<string>();
          ...
          <div className="max-w-4xl mx-auto">
            <GlassPanel>
              <div className="text-center py-12">
                ...
                <Button onClick={() => navigate('/icp')} variant="gradient">
                  Start ICP Interview
                </Button>
              </div>
            </GlassPanel>
          ...
          <div className="max-w-4xl mx-auto">
            <GlassPanel>
              <div className="text-center py-12">
                ...
                <Button onClick={() => navigate('/beta-content')} variant="gradient">
                  View PRO Features
                </Button>
              </div>
            </GlassPanel>
                  ...
                  {validatedIdea ? (
                    <div className="space-y-6">
                      ...
                      <div className="flex justify-between items-center">
                        <Button variant="outline" onClick={() => setCurrentStage('avatar')}>
                          <ArrowLeft className="w-4 h-4 mr-2" />
                          Back to Avatar
                        </Button>
                ...
                <div className="space-y-6">
                  ...
                  {contentRoot ? (
                    <div className="space-y-6">
                      ...
                      <div className="flex justify-between">
                        <Button variant="outline" onClick={() => setCurrentStage('validation')}>
                          <ArrowLeft className="w-4 h-4 mr-2" />
                          Back to Validation
                        </Button>
                        <Button
